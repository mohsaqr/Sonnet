...
## ----vectors-plot, fig.cap="Multilevel network (layers)"----------------------
splot(net_layers)

## ----vectors-no-nodes, fig.show='hide'----------------------------------------
...
## ----clusters-plot, fig.cap="Multi-cluster network"---------------------------
splot(net_clusters)

## ----named-list, fig.show='hide'----------------------------------------------
...
## ----groups-plot, fig.cap="Heterogeneous network (groups)"--------------------
splot(net_groups)
...
## ----community-plot, fig.cap="Auto-detected communities"----------------------
splot(net_auto)
...
## ----pipe-workflow, fig.cap="Complete pipe workflow"--------------------------
