...
## ----basic-plot, fig.cap="Default TNA plot"-----------------------------------
splot(model)

## ----shapes-gallery, fig.cap="Node shape gallery"-----------------------------
...
## ----shape-groupings, fig.cap="Shape-based categorization"--------------------
...
## ----fonts, fig.cap="Font customization"--------------------------------------
...
## ----layout-circle, fig.cap="Circle layout"-----------------------------------
splot(model, layout = "circle", node_size = 4)

## ----layout-spring, fig.cap="Spring (force-directed) layout"------------------
splot(model, layout = "spring", node_size = 4)

## ----layout-oval, fig.cap="Oval layout"---------------------------------------
splot(model, layout = "oval", node_size = 4)

## ----layout-two-row, fig.cap="Two-row horizontal layout"----------------------
layout_2row <- cbind(
...
## ----layout-three-row, fig.cap="Three-row hierarchical layout"----------------
...
## ----layout-diamond, fig.cap="Diamond formation"------------------------------
...
## ----layout-spiral, fig.cap="Spiral arrangement"------------------------------
...
## ----layout-grid, fig.cap="Grid arrangement"----------------------------------
ncol <- ceiling(sqrt(n))
nrow <- ceiling(n / ncol)
layout_grid <- cbind(
...
## ----layout-radial, fig.cap="Radial cluster layout"---------------------------
...
## ----layout-arc, fig.cap="Arc arrangement"------------------------------------
...
## ----combined-1, fig.cap="Combined styling: shapes, layout, fonts"------------
splot(model,
      layout = "circle",
...
## ----combined-2, fig.cap="Hierarchical layout with donut charts"--------------
splot(model,
      layout = layout_3row,
      layout_scale = 1.3,
...
## ----combined-3, fig.cap="Radial layout with shape categories"----------------
splot(model,
      layout = layout_radial,
      layout_scale = 1.2,
...
## ----edges, fig.cap="Edge customization"--------------------------------------
...
## ----themes, fig.cap="Built-in themes"----------------------------------------
...
## ----publication, fig.width=8, fig.height=7, fig.cap="Publication-ready visualization"----
splot(model,
      # Layout
      layout = "circle",
      layout_scale = 1.2,
